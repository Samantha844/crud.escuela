...
//    public ResponseEntity<ColegiaturaDTO> obtenerColegiaturasPorId(@RequestParam Integer idColegiatura){
//        ColegiaturaDTO respuesta = colegiaturaServicio.obtenerColegiaturasPorId(idColegiatura);
//        return new ResponseEntity<>(respuesta, HttpStatus.OK);
//    }
//
//    @PostMapping("guardar")
...
//    public ResponseEntity<Boolean> eliminarColegiatura(@RequestParam Integer idColegiatura){
//        Boolean respuesta = colegiaturaServicio.eliminarColegiatura(idColegiatura);
//        return new ResponseEntity<>(respuesta, HttpStatus.OK);
//    }
//    @PutMapping("activar-inactivar")
//    public ResponseEntity<Boolean> activarInactivarColegiatura(@RequestBody Integer idColegiatura){
//        Boolean respuesta = colegiaturaServicio.activarInactivarColegiatura(idColegiatura);
//        return new ResponseEntity<>(respuesta, HttpStatus.OK);
//    }
}
